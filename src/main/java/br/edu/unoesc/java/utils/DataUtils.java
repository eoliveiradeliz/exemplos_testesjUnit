package br.edu.unoesc.java.utils;
...
public class DataUtils {
	...
	/**
	 * Retorna a data enviada por parametro incremento de dias passado por parametro
	 ...
	 * @return
	 */
	public static Date incDays(Date data, int dias) {
	 ...
	 */
	public static Date getDate(int dias) {
		return incDays(new Date(), dias);
	}
	 ...
	 * @return
	 */
	public static boolean isEguals(Date data1, Date data2) {
	 ...
	 * @return
	 */
	public static boolean isWeekDay(Date data, int diaSemana) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(data);
